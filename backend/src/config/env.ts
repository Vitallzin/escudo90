...
export const env = {
  ...
  firebaseApiKey: readString('FIREBASE_API_KEY'),
  firebaseAuthDomain: readString('FIREBASE_AUTH_DOMAIN'),
  firebaseProjectId: readString('FIREBASE_PROJECT_ID'),
  firebaseStorageBucket: readString('FIREBASE_STORAGE_BUCKET'),
  firebaseMessagingSenderId: readString('FIREBASE_MESSAGING_SENDER_ID'),
  firebaseAppId: readString('FIREBASE_APP_ID'),
  firebaseMeasurementId: readString('FIREBASE_MEASUREMENT_ID'),
} as const
